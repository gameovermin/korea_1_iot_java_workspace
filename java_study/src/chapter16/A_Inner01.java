...
//	private static String outerField = "외부 클래스의 필드";
...
//			System.out.println("외부 클래스 필드에 접근(인스턴스): " + outerField);	//	- Error
		...
		void display2(OuterClass outer) {
			System.out.println("매개변수를 이용한 private 변수에 접근 : " + outer.outerField);
