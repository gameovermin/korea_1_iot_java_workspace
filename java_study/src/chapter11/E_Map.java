...
public class E_Map {
	public static void main(String[] args) {
		...
		//	cf) 컬렉션 프레임 워크는 객체 저장시 래퍼 클래스(참조값 저장)를 사용
		...
		System.out.println(student.get("전사"));
		
		System.out.println(student.containsKey("도적"));
		System.out.println(student.containsKey("해적"));
		
		System.out.println(student.size());
		
		System.out.println(student.keySet());
		
		System.err.println(student.values());
